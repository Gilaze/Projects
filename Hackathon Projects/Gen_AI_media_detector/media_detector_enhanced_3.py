                    ...
                    if image_base64:
                        ...
                        if analysis:
                            ...
                            if alert_type != 'none':
                                ...
                                # Show the initial notification IMMEDIATELY
                                ...
                                # The "Show Context" button in the notification
                                # will now handle the fact-checking when clicked,
                                # so the initial alert is fast.
