...
try:
    ...
    CHECK_INTERVAL = 30 # CHANGED: Was 5. Set to 30s to guarantee < 5 requests/min (2 checks/min * 2 requests/detection = 4 requests)
    NOTIFICATION_DURATION = 7000 # CHANGED: Was 5000 (5s), now 7000 (7s)
    ...
    def analyze_with_claude(self, image_base64):
        ...
        try:
            response = requests.post(
                ...
                json={
                    # CORRECTED MODEL NAME (1 of 4) - Using stable Haiku
    ...
    def fact_check_claim(self, claim_text):
        ...
        try:
            ...
            fact_check_response = requests.post(
                ...
                json={
                    # CORRECTED MODEL NAME (3 of 4) - Using stable Haiku
                    "model": "claude-3-haiku-20240307",
                    "max_tokens": 1000,
                    "messages": [
                        {
    ...
    def get_context(self, claim_text):
        ...
        try:
            response = requests.post(
                ...
                json={
                    # CORRECTED MODEL NAME (4 of 4) - Using stable Haiku
                    "model": "claude-3-haiku-20240307",
                    "max_tokens": 2000,
                    "messages": [
                        {
